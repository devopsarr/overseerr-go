...
type _GetSearchCompany2XXResponse GetSearchCompany2XXResponse
...
func NewGetSearchCompany2XXResponse() *GetSearchCompany2XXResponse {
	this := GetSearchCompany2XXResponse{}
	return &this
}
...
type NullableGetSearchCompany2XXResponse struct {
	value *GetSearchCompany2XXResponse
	isSet bool
}

func (v NullableGetSearchCompany2XXResponse) Get() *GetSearchCompany2XXResponse {
	return v.value
}

func (v *NullableGetSearchCompany2XXResponse) Set(val *GetSearchCompany2XXResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSearchCompany2XXResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSearchCompany2XXResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSearchCompany2XXResponse(val *GetSearchCompany2XXResponse) *NullableGetSearchCompany2XXResponse {
	return &NullableGetSearchCompany2XXResponse{value: val, isSet: true}
}

func (v NullableGetSearchCompany2XXResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSearchCompany2XXResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
