...
func (r ApiGetMovieRatingscombinedRequest) Execute() (*GetMovieRatingscombined2XXResponse, *http.Response, error) {
...
// Execute executes the request
//  @return GetMovieRatingscombined2XXResponse
func (a *MoviesAPIService) GetMovieRatingscombinedExecute(r ApiGetMovieRatingscombinedRequest) (*GetMovieRatingscombined2XXResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMovieRatingscombined2XXResponse
	)
