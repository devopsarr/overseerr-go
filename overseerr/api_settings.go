...
type ApiListNotificationsPushoverSoundsRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	token *string
}

func (r ApiListNotificationsPushoverSoundsRequest) Token(token string) ApiListNotificationsPushoverSoundsRequest {
	r.token = &token
	return r
}

func (r ApiListNotificationsPushoverSoundsRequest) Execute() ([]ListNotificationsPushoverSounds2XXResponseInner, *http.Response, error) {
	return r.ApiService.ListNotificationsPushoverSoundsExecute(r)
}

/*
ListNotificationsPushoverSounds Get Pushover sounds

Returns valid Pushover sound options in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListNotificationsPushoverSoundsRequest
*/
func (a *SettingsAPIService) ListNotificationsPushoverSounds(ctx context.Context) ApiListNotificationsPushoverSoundsRequest {
	return ApiListNotificationsPushoverSoundsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ListNotificationsPushoverSounds2XXResponseInner
func (a *SettingsAPIService) ListNotificationsPushoverSoundsExecute(r ApiListNotificationsPushoverSoundsRequest) ([]ListNotificationsPushoverSounds2XXResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ListNotificationsPushoverSounds2XXResponseInner
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.ListNotificationsPushoverSounds")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
