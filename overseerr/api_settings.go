...
func (r ApiListNotificationsPushoverSoundsRequest) Execute() ([]*ListNotificationsPushoverSounds200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []ListNotificationsPushoverSounds200ResponseInner
func (a *SettingsAPIService) ListNotificationsPushoverSoundsExecute(r ApiListNotificationsPushoverSoundsRequest) ([]*ListNotificationsPushoverSounds200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []*ListNotificationsPushoverSounds200ResponseInner
	)
