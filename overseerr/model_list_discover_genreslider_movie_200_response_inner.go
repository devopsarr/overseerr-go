...
// ListDiscoverGenresliderMovie200ResponseInner struct for ListDiscoverGenresliderMovie200ResponseInner
type ListDiscoverGenresliderMovie200ResponseInner struct {
...
type _ListDiscoverGenresliderMovie200ResponseInner ListDiscoverGenresliderMovie200ResponseInner
...
func NewListDiscoverGenresliderMovie200ResponseInner() *ListDiscoverGenresliderMovie200ResponseInner {
	this := ListDiscoverGenresliderMovie200ResponseInner{}
	return &this
}
...
func (o ListDiscoverGenresliderMovie200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o *ListDiscoverGenresliderMovie200ResponseInner) UnmarshalJSON(bytes []byte) (err error) {
	varListDiscoverGenresliderMovie200ResponseInner := _ListDiscoverGenresliderMovie200ResponseInner{}

	if err = json.Unmarshal(bytes, &varListDiscoverGenresliderMovie200ResponseInner); err == nil {
		*o = ListDiscoverGenresliderMovie200ResponseInner(varListDiscoverGenresliderMovie200ResponseInner)
	}
...
type NullableListDiscoverGenresliderMovie200ResponseInner struct {
	value *ListDiscoverGenresliderMovie200ResponseInner
	isSet bool
}

func (v NullableListDiscoverGenresliderMovie200ResponseInner) Get() *ListDiscoverGenresliderMovie200ResponseInner {
	return v.value
}

func (v *NullableListDiscoverGenresliderMovie200ResponseInner) Set(val *ListDiscoverGenresliderMovie200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListDiscoverGenresliderMovie200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListDiscoverGenresliderMovie200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDiscoverGenresliderMovie200ResponseInner(val *ListDiscoverGenresliderMovie200ResponseInner) *NullableListDiscoverGenresliderMovie200ResponseInner {
	return &NullableListDiscoverGenresliderMovie200ResponseInner{value: val, isSet: true}
}

func (v NullableListDiscoverGenresliderMovie200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDiscoverGenresliderMovie200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
