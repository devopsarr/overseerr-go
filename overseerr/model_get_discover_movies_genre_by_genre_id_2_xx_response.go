...
func (o *GetDiscoverMoviesGenreByGenreId2XXResponse) UnmarshalJSON(bytes []byte) (err error) {
	varGetDiscoverMoviesGenreByGenreId2XXResponse := _GetDiscoverMoviesGenreByGenreId2XXResponse{}

	if err = json.Unmarshal(bytes, &varGetDiscoverMoviesGenreByGenreId2XXResponse); err == nil {
