...
// GetIssueCount200Response struct for GetIssueCount200Response
type GetIssueCount200Response struct {
...
type _GetIssueCount200Response GetIssueCount200Response
...
func (o GetIssueCount200Response) MarshalJSON() ([]byte, error) {
...
func (o *GetIssueCount200Response) UnmarshalJSON(bytes []byte) (err error) {
	varGetIssueCount200Response := _GetIssueCount200Response{}

	if err = json.Unmarshal(bytes, &varGetIssueCount200Response); err == nil {
		*o = GetIssueCount200Response(varGetIssueCount200Response)
	}
...
type NullableGetIssueCount200Response struct {
	value *GetIssueCount200Response
	isSet bool
}

func (v NullableGetIssueCount200Response) Get() *GetIssueCount200Response {
	return v.value
}

func (v *NullableGetIssueCount200Response) Set(val *GetIssueCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIssueCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIssueCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIssueCount200Response(val *GetIssueCount200Response) *NullableGetIssueCount200Response {
	return &NullableGetIssueCount200Response{value: val, isSet: true}
}

func (v NullableGetIssueCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIssueCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
